import{j as e,n as i,r as p,a as G,b as H,d as l,e as K,f as Q,g as V,h as W,o as Z,u as J}from"./index-f94ae407.js";import{f as X,S as Y,I as _}from"./AdminCabinetPage.styled-6f786c57.js";const ee=({users:r})=>e.jsx(e.Fragment,{children:e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:" Name"}),e.jsx("th",{children:"Day of Birthday"}),e.jsx("th",{children:"Tel Number"}),e.jsx("th",{children:"Email"})]})}),e.jsx("tbody",{children:r.map((a,x)=>e.jsxs("tr",{children:[e.jsx("td",{children:a.firstName}),e.jsxs("td",{children:[a.lastName," ",a.fatherName]}),e.jsx("td",{children:a.dayOfBirthday}),e.jsx("td",{children:a.telNumber}),e.jsx("td",{children:a.email})]},x))})]})}),te=i.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
