import{j as e,n as i,r as a,a as m,u as j}from"./index-ffb0a480.js";const u=({users:t})=>e.jsx(e.Fragment,{children:e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:" Name"}),e.jsx("th",{children:"Day of Birthday"}),e.jsx("th",{children:"Tel Number"}),e.jsx("th",{children:"Email"})]})}),e.jsx("tbody",{children:t.map((n,o)=>e.jsxs("tr",{children:[e.jsx("td",{children:n.firstName}),e.jsxs("td",{children:[n.lastName," ",n.fatherName]}),e.jsx("td",{children:n.dayOfBirthday}),e.jsx("td",{children:n.telNumber}),e.jsx("td",{children:n.email})]},o))})]})}),g=i.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
