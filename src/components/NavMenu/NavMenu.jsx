    ...
    <Nav>
      <List>
        <Item>
          ...
          <NavigationLink href="/cabinet">Кабінет</NavigationLink>
        </Item>
        <Item>
          <svg className="icon" width="24" height="24">
        ...
        <Item>
          ...
          <NavigationLink href="/user">Користувачі</NavigationLink>
        </Item>
        <Item>
          {" "}
          <svg className="icon" width="24" height="24">
          ...
          <NavigationLink href="/online">Онлайн</NavigationLink>
        </Item>
        <Item>
          <svg className="icon" width="24" height="24">
            <use href={`${symbol}#icon-analytics`}></use>
          </svg>
          <NavigationLink href="/analytics">Аналітика</NavigationLink>
        </Item>
      </List>
    </Nav>
  );
